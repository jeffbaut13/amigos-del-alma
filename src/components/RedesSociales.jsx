      ...
      <div className="flex items-center lg:h-2/3 xs:h-1/2 w-[70%] relative border border-[--borderOpacity] p-2 border-dashed rounded-xl overflow-hidden">
        <div className="border border-[--borderOpacity] w-full h-full flex flex-col items-center justify-evenly bg-black bg-opacity-30 rounded-xl">
          ...
          <div className="flex w-full flex-col z-10">
            <h2 className="w-full NeueHassRoman text-center text-xs text-[--tercero]">
              compártele este contenido aquí
            </h2>
            <div className="w-full flex flex-col mt-8 justify-around items-center gap-2">
              <button className="group bg-[--tercero] hover:bg-[#ffffff00] border border-[--borderOpacity] w-32 rounded-sm flex items-center justify-center py-2.5 px-3 transition-all duration-300">
              ...
              <button className="group bg-[--tercero] hover:bg-[#ffffff00] border border-[--second] w-32 rounded-sm flex items-center justify-center py-2.5 pl-5 pr-3.5 transition-all duration-300">
                <span className="w-6 h-6 inline-block">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
