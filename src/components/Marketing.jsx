  ...
  return (
    ...
    >
      ...
      <div className="contaiMarket z-10 relative w-4/5 h-full flex items-center justify-center">
        <div className="containMarket_child  p-2 flex max-lg:flex-col-reverse relative justify-between rounded-xl border w-full lg:h-4/6 xs:h-5/6 max-lg:gap-2  border-dashed border-[#E1C5B550]">
